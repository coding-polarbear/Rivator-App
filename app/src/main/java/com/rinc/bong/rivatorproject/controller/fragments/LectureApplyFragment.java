...
public class LectureApplyFragment extends Fragment {
    ...
    private void loadCourseData() {
        ...
        Call<CourseManagerListGet> call = courseService.getCourseManagerListWithStatus(0, 999, user.getUserId(), 0);
        call.enqueue(new Callback<CourseManagerListGet>() {
            ...
            public void onFailure(Call<CourseManagerListGet> call, Throwable t) {
                SnackBarUtill.makeSnackBar(view, "알 수 업는 오류가 발생하였습니다!", Snackbar.LENGTH_SHORT);
            }
        });
    }
